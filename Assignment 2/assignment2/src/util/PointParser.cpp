...
namespace PointParser {
    ...
    PickUpObject extract_pick_up_object_from_msg(const assignment2::PickUpObject& object_msg)
    {
    ...
    PickUpObstacle extract_pick_up_obstacle_from_msg(const assignment2::PickUpObstacle& obstacle_msg)
    {
    ...
    assignment2::PickUpObject build_pick_up_object_msg_pose(const PickUpObject& object)
    {
        assignment2::PickUpObject object_msg;
    ...
    assignment2::PickUpObstacle build_pick_up_obstacle_msg_pose(const PickUpObstacle& obstacle)
    {
        assignment2::PickUpObstacle obstacle_msg;
