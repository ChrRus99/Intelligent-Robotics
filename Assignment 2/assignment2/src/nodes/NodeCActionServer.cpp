...
void NodeCActionServer::manipulate_callback(const assignment2::ObjectManipulationGoalConstPtr& goal)
{
    ...
    if(goal->modality) {
        ...
        assignment2::PickUpObject target_object_msg = goal->target_object;
        ...
        vector<assignment2::PickUpObject> objects_msgs = goal->objects;
        vector<assignment2::PickUpObstacle> obstacles_msgs = goal->obstacles;
