...
{
    // Build the goal
    custom_msgs::NavigationGoal goal;
...
void NavigationActionClient::done_callback(const actionlib::SimpleClientGoalState& state, const custom_msgs::NavigationResultConstPtr& result) 
{
...
void NavigationActionClient::feedback_callback(const custom_msgs::NavigationFeedbackConstPtr& feedback)
{
